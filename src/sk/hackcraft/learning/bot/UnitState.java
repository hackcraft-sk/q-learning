...
public class UnitState implements IState {
	...
	public UnitState(String hashCode, int lifeFrom, int lifeTo, int underAttack, double armyLifeRatioFrom, double armyLifeRationTo, double closestEnemyDistanceFrom, double closestEnemyDistanceTo, int closestEnemyLifeFrom, int closestEnemyLifeTo, double closestArmyLifeRatioFrom, double closestArmyLifeRatioTo, double mostWoundedEnemyDistanceFrom, double mostWoundedEnemyDistanceTo, int mostWoundedEnemyLifeFrom, int mostWoundedEnemyLifeTo, double mostWoundedArmyLifeRatioFrom, double mostWoundedArmyLifeRatioTo, double groupCenterDinstanceFrom, double groupCenterDistanceTo) {
	...
	public String toString() {
		return ("State " + hashCode + " ["
				+ "life["+lifeFrom+","+lifeTo+"] "
				+ "underA["+underAttack+"] "
				+ "armyLife["+armyLifeRatioFrom+","+armyLifeRationTo+"] "
				+ "ceDis["+(int)closestEnemyDistanceFrom+","+(int)closestEnemyDistanceTo+"] "
				+ "ceLife["+closestEnemyLifeFrom+","+closestEnemyLifeTo+"] "
				+ "ceArmyLife["+closestArmyLifeRatioFrom+","+closestArmyLifeRatioTo+"] "
				+ "mweDis["+(int)mostWoundedEnemyDistanceFrom+","+(int)mostWoundedEnemyDistanceTo+"] "
				+ "mweLife["+mostWoundedEnemyLifeFrom+","+mostWoundedEnemyLifeTo+"] "
				+ "mweArmyLife["+mostWoundedArmyLifeRatioFrom+","+mostWoundedArmyLifeRatioTo+"] "
				+ "gcDis["+(int)groupCenterDinstanceFrom+","+(int)groupCenterDistanceTo+"]"
				);
	}
