...
public class Bot extends DefaultBWListener {
	...
	private UnitAction[] actions = new UnitAction[]{	new RunAction(),
														new AttackMostWoundedAction(),
														new AttackNearestAction(),
														new DoNothingAction(),
														new FleeFromEnemyAction(),
														new FleeToCenterAction(),
														new AttackWeakestGroupAction()
														};
    ...
    public void onFrame() {
    	...
    	game.drawTextScreen(10, 20, "Score:" + postGameStats.getWin() + " / "+ postGameStats.getLoose());
    	game.drawTextScreen(10, 30, "Average statistic");
    	game.drawTextScreen(10, 40, "Winrate: "+ postGameStats.getWin()/(postGameStats.getWin()+postGameStats.getLoose()));
    	game.drawTextScreen(10, 50, "Frame count: " +postGameStats.getFrameCount());
    	game.drawTextScreen(10, 60, "Life difference count: " +postGameStats.getLifeDifference());
    	game.drawTextScreen(10, 70, "Unit count difference: " +postGameStats.getUnitDifference());
    ...
    public void onEnd(boolean winner) {
    	...
    	postGameStats.add(game.getFrameCount(), winner, groupHp-enemyGroupHp, game.self().getUnits().size() - game.enemy().getUnits().size());
    	statistics.endGame();
    }
